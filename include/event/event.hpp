...
namespace Core
{
	 ...
	 * what event this is we use that reference and Dispatch() function multiple
	 * times until it matches the static type. It then calls that event function
	 * that we input to the dispatch function.
	 */
	...
	public:
		...
		/*
		 * Simply explained, a way to call functions when an event is called.
		 * Automates the if statements and casting that would be present if
		 * this did not exist. 
		 * 
